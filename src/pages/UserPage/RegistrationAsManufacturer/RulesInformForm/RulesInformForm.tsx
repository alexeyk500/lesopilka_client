  ...
  return (
    <div className={classes.container}>
      <div className={classes.mainPart}>
        ...
        <p className={classes.title}>
          Пользователь площадки не может быть одновременно поставщиком пиломатериалов и реселлером, в случае успешной
          регистрации пользователя как поставщика пиломатериалов, доступ пользователя к регистрации как реселлера будет
          закрыт.
        </p>
      </div>
    </div>
